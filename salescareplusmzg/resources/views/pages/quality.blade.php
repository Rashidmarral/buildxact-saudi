<x-layout title="Quality & Certifications" description="Discover the regulatory registrations, licences and quality practices behind Sales Care Plus MZG's medicine distribution operations.">
    ...
    <section class="bg-teal-pattern py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 class="hero-fade-in hero-fade-in-delay-1 mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl">Quality You Can Verify</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 pt-16 sm:px-6 lg:px-8">
        <div class="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div class="reveal">
                <span class="text-sm font-semibold uppercase tracking-wide text-coral-600">Cold-Chain Discipline</span>
                <h2 class="mt-3 text-3xl font-bold text-teal-900">Every Degree Monitored, Every Batch Tracked</h2>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="reveal-stagger grid grid-cols-1 gap-6 sm:grid-cols-2">
            @foreach ($certifications as $certification)
                <div class="flex gap-5 rounded-2xl border border-slate-100 p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="reveal-stagger mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ([
                    ...
                    <div class="rounded-2xl border border-teal-800 bg-teal-900/60 p-6 transition duration-300 hover:-translate-y-1 hover:border-coral-500">
                        ...
                        <p class="mt-2 text-sm leading-relaxed text-teal-200">{{ $standard['text'] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
