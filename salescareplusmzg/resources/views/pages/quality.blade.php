<x-layout title="Quality & Certifications" description="Discover the regulatory registrations, licences and quality practices behind Sales Care Plus MZG's medicine distribution operations.">
    ...
    <section class="bg-leaf-pattern bg-leaf-50 py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 class="hero-fade-in hero-fade-in-delay-1 mt-6 text-4xl font-bold tracking-tight text-leaf-950 sm:text-5xl">Quality You Can Verify</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="reveal-stagger grid grid-cols-1 gap-6 sm:grid-cols-2">
            @foreach ($certifications as $certification)
                <div class="flex gap-5 rounded-2xl border border-stone-100 p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
