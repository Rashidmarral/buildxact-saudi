    ...
    <section class="bg-leaf-pattern bg-leaf-50 py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <span class="inline-flex items-center gap-2 rounded-full bg-leaf-100 px-4 py-1.5 text-sm font-medium text-leaf-700">
                <x-icon name="leaf" class="h-4 w-4" /> Gallery
            </span>
            <h1 class="mt-6 text-4xl font-bold tracking-tight text-leaf-950 sm:text-5xl">A Look Inside Our Operations</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            @foreach ([
                ...
                <div class="group relative aspect-square overflow-hidden rounded-2xl {{ $item['bg'] }} text-white">
                    <div class="flex h-full w-full flex-col items-center justify-center gap-3 p-4 text-center transition group-hover:scale-105">
