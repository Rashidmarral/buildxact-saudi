<x-layout title="Careers" description="Join the Sales Care Plus MZG team in Muzaffargarh — opportunities in sales, logistics, warehousing and pharmacy support.">
    ...
    <section class="bg-leaf-pattern bg-leaf-50 py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 class="hero-fade-in hero-fade-in-delay-1 mt-6 text-4xl font-bold tracking-tight text-leaf-950 sm:text-5xl">Build Your Career With Us</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="reveal-stagger grid grid-cols-1 gap-6 md:grid-cols-2">
            @foreach ([
                ...
                <div class="rounded-2xl border border-stone-100 p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <a href="{{ route('contact') }}" class="group mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-leaf-700 hover:text-leaf-800">
        ...
        <div class="reveal mt-14 rounded-2xl bg-leaf-50/60 p-8 text-center">
            ...
            <a href="{{ route('contact') }}" class="mt-5 inline-flex items-center gap-2 rounded-full bg-leaf-600 px-6 py-3 font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-leaf-700 hover:shadow-lg">
                Get in Touch
            </a>
        </div>
    </section>
