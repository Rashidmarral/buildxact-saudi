<x-layout title="Our Services" description="From warehousing to last-mile delivery, discover the distribution services Sales Care Plus MZG provides to pharmacies, clinics and hospitals in Muzaffargarh.">
    ...
    <section class="bg-leaf-pattern bg-leaf-50 py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 class="mt-6 text-4xl font-bold tracking-tight text-leaf-950 sm:text-5xl">End-to-End Distribution Services</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            @foreach ([
                ...
                <div class="rounded-2xl border border-stone-100 p-7 shadow-sm transition hover:shadow-md">
    ...
    <section class="bg-leaf-50/60 py-20">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <ol class="mt-14 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ([
    ...
    <section class="bg-sand-500">
        <div class="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
            ...
            <a href="{{ route('contact') }}" class="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3.5 font-semibold text-sand-700 shadow-sm transition hover:bg-sand-50">
