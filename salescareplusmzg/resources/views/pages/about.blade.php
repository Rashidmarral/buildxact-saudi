    ...
    <section class="bg-leaf-pattern bg-leaf-50 py-16 sm:py-20">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <span class="hero-fade-in inline-flex items-center gap-2 rounded-full bg-leaf-100 px-4 py-1.5 text-sm font-medium text-leaf-700">
                <x-icon name="leaf" class="h-4 w-4 animate-leaf-sway" /> About Sales Care Plus MZG
            </span>
            <h1 class="hero-fade-in hero-fade-in-delay-1 mt-6 text-4xl font-bold tracking-tight text-leaf-950 sm:text-5xl">Our Story, Rooted in Muzaffargarh</h1>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div class="reveal-stagger grid grid-cols-2 gap-4">
                <div class="rounded-2xl bg-leaf-600 p-6 text-white transition-transform duration-300 hover:-translate-y-1">
                ...
                <div class="rounded-2xl bg-sand-500 p-6 text-white transition-transform duration-300 hover:-translate-y-1">
                    <p class="text-3xl font-bold">300+</p>
                    <p class="mt-1 text-sm text-sand-50">Partner pharmacies</p>
                </div>
                <div class="rounded-2xl bg-leaf-100 p-6 text-leaf-900 transition-transform duration-300 hover:-translate-y-1">
                    <p class="text-3xl font-bold">8</p>
                    <p class="mt-1 text-sm text-leaf-700">Therapeutic categories</p>
                </div>
                <div class="rounded-2xl bg-stone-100 p-6 text-stone-900 transition-transform duration-300 hover:-translate-y-1">
    ...
    <section class="bg-leaf-50/60 py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="reveal-stagger grid gap-6 md:grid-cols-2">
                <div class="rounded-2xl border border-leaf-100 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:shadow-lg">
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div class="reveal-stagger mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            @foreach ([
                ...
                <div class="rounded-2xl border border-stone-100 p-6 text-center shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <span class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-leaf-100 text-leaf-700 transition-transform duration-300 hover:scale-110">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="reveal-stagger mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ($team as $member)
                    <div class="rounded-2xl border border-leaf-800 bg-leaf-900/60 p-6 text-center transition duration-300 hover:-translate-y-1 hover:border-leaf-600">
                        <span class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-leaf-600 text-lg font-bold text-white transition-transform duration-300 hover:scale-110">
                            {{ $member->initials }}
                        </span>
