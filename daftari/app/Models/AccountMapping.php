...
class AccountMapping extends Model
{
    ...
    public static function catalog(): array
    {
        $entries = [
            ...
            'SALARY_EXPENSE' => ['label' => 'Salaries & wages expense', 'default_code' => '5350'],
            'GOSI_EXPENSE' => ['label' => 'GOSI expense (employer share)', 'default_code' => '5360'],
            'GOSI_PAYABLE' => ['label' => 'GOSI payable', 'default_code' => '2260'],
            'SALARIES_PAYABLE' => ['label' => 'Salaries payable', 'default_code' => '2270'],
