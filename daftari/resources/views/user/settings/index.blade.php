...
<div class="max-w-2xl mt-6 bg-white rounded-xl border border-slate-100 p-6 flex items-center justify-between">
    <div>
        <h3 class="font-semibold text-slate-900">{{ __('API tokens') }}</h3>
        <p class="text-sm text-slate-500 mt-1">{{ __('Generate personal access tokens to use the Daftari API from your own scripts and integrations.') }}</p>
    </div>
    <a href="{{ route('app.settings.api-tokens') }}" class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:border-slate-300">
        {{ __('Manage') }}
    </a>
</div>
...
<div class="max-w-2xl mt-6 bg-white rounded-xl border border-slate-100 p-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-1">{{ __('Let clients pay your invoices online with mada, cards, Apple Pay, or STC Pay.') }}</p>
    </div>
    <a href="{{ route('app.settings.payment-gateways') }}" class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:border-slate-300">
        {{ __('Manage') }}
    </a>
</div>
...
<div class="max-w-2xl mt-6 bg-white rounded-xl border border-slate-100 p-6 flex items-center justify-between">
    <div>
        <h3 class="font-semibold text-slate-900">{{ __('Tax rates') }}</h3>
        <p class="text-sm text-slate-500 mt-1">{{ __('The VAT rates available on invoice, bill, and quotation lines.') }}</p>
    </div>
    <a href="{{ route('app.tax-rates.index') }}" class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:border-slate-300">
        {{ __('Manage') }}
    </a>
</div>
...
<div class="max-w-2xl mt-6 bg-white rounded-xl border border-slate-100 p-6 flex items-center justify-between">
    ...
    <a href="{{ route('app.settings.approvals') }}" class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:border-slate-300">
        {{ __('Manage') }}
    </a>
</div>
...
<div class="max-w-2xl mt-6 bg-white rounded-xl border border-slate-100 p-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-1">{{ __('Add your own fields to clients, suppliers, and items.') }}</p>
    </div>
    <a href="{{ route('app.settings.custom-fields.index') }}" class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:border-slate-300">
        {{ __('Manage') }}
    </a>
</div>
