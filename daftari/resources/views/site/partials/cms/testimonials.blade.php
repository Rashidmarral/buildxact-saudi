    ...
    <div class="mx-auto max-w-6xl px-6">
        ...
        <div class="perspective grid gap-6 md:grid-cols-3">
            @foreach ($section->items as $i => $item)
                <div x-data x-reveal x-tilt style="animation-delay: {{ $i * 80 }}ms" class="relative rounded-2xl border border-slate-100 bg-white p-6 transition-shadow duration-300 hover:shadow-card-hover">
                    <svg class="tilt-pop h-7 w-7 text-brand-200" viewBox="0 0 24 24" fill="currentColor"><path d="M7.17 6C4.87 6 3 7.87 3 10.17c0 2.3 1.87 4.17 4.17 4.17.34 0 .67-.04.98-.12-.4 1.3-1.4 2.4-3.15 2.85v2.4c3.6-.5 5.83-3.05 5.83-6.86V10.17C10.83 7.87 8.96 6 6.66 6h.51zm10.66 0c-2.3 0-4.17 1.87-4.17 4.17 0 2.3 1.87 4.17 4.17 4.17.34 0 .67-.04.98-.12-.4 1.3-1.4 2.4-3.15 2.85v2.4c3.6-.5 5.83-3.05 5.83-6.86V10.17C21.49 7.87 19.62 6 17.32 6h.51z"/></svg>
                    <div class="prose-cms mt-3 text-sm text-slate-600">{!! $item->bodyHtml() !!}</div>
