...
<div class="max-w-2xl bg-white rounded-xl border border-slate-100 p-6">
    ...
    <a href="{{ route('admin.settings.two-factor') }}" class="mt-6 inline-block rounded-lg bg-brand-600 px-6 py-2.5 font-semibold text-white hover:bg-brand-700">{{ __("I've saved these codes") }}</a>
</div>
@endsection
