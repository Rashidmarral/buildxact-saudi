...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-3 mb-8">
    <div class="bg-white rounded-xl border border-slate-100 p-5">
        ...
        <p class="text-2xl font-bold text-slate-900">SAR {{ number_format($outstanding, 2) }}</p>
    </div>
    <div class="bg-white rounded-xl border border-slate-100 p-5">
        <p class="text-xs font-medium text-slate-500 mb-1">{{ __('Total invoiced') }}</p>
        <p class="text-2xl font-bold text-slate-900">SAR {{ number_format($totalInvoiced, 2) }}</p>
    </div>
    <div class="bg-white rounded-xl border border-slate-100 p-5">
