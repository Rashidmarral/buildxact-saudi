...
class CmsContentSeeder extends Seeder
{
    ...
    private function seedHome(): void
    {
        ...
        $this->item($features, 1, ['icon' => 'zatca', 'title_en' => 'ZATCA-style QR invoices', 'title_ar' => 'فواتير برمز QR على غرار متطلبات هيئة الزكاة والضريبة والجمارك', 'body_en' => 'Every tax invoice carries a scannable QR code encoding seller, VAT number, timestamp, and totals.', 'body_ar' => 'تحمل كل فاتورة ضريبية رمز QR قابل للمسح يتضمن بيانات البائع والرقم الضريبي والتاريخ والوقت والإجماليات.']);
        $this->item($features, 2, ['icon' => 'trend-up', 'title_en' => 'One-click VAT reports', 'title_ar' => 'تقارير ضريبية بنقرة واحدة', 'body_en' => 'See output VAT, input VAT, and net VAT due for any period — ready for your return.', 'body_ar' => 'اطّلع على ضريبة المخرجات وضريبة المدخلات وصافي الضريبة المستحقة لأي فترة — جاهزة لإقرارك الضريبي.']);
        $this->item($features, 3, ['icon' => 'team', 'title_en' => 'Client & item catalog', 'title_ar' => 'دليل العملاء والعناصر', 'body_en' => 'Save clients and price lists once, reuse them on every invoice.', 'body_ar' => 'احفظ بيانات العملاء وقوائم الأسعار مرة واحدة، وأعد استخدامها في كل فاتورة.']);
        $this->item($features, 4, ['icon' => 'billing', 'title_en' => 'Expense tracking', 'title_ar' => 'تتبع المصروفات', 'body_en' => 'Log purchases and reclaimable VAT by category, vendor, and date.', 'body_ar' => 'سجّل المشتريات وضريبة المدخلات القابلة للاسترداد حسب الفئة والمورّد والتاريخ.']);
        $this->item($features, 5, ['icon' => 'globe', 'title_en' => 'Bilingual, RTL-ready', 'title_ar' => 'ثنائي اللغة، وجاهز للعرض من اليمين لليسار', 'body_en' => 'Full Arabic and English interface with proper right-to-left layout.', 'body_ar' => 'واجهة كاملة بالعربية والإنجليزية مع تخطيط صحيح من اليمين إلى اليسار.']);
        $this->item($features, 6, ['icon' => 'shield', 'title_en' => 'Team access', 'title_ar' => 'وصول الفريق', 'body_en' => 'Invite your bookkeeper or staff with role-based access to your books.', 'body_ar' => 'ادعُ محاسبك أو موظفيك مع صلاحيات وصول محددة حسب الدور إلى سجلاتك المحاسبية.']);
